...
var _user$project$View$clientTableRow = function (client) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Table$tr,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(client.name),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(client.surname),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(client.age)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$View$clientTableData = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Table$tbody,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$View$clientTableRow, model.clients));
};
var _user$project$View$clientTable = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: _rundis$elm_bootstrap$Bootstrap_Table$table(
				{
					...
					thead: _rundis$elm_bootstrap$Bootstrap_Table$simpleThead(
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Surname'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
					...
					tbody: _user$project$View$clientTableData(model)
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$clientPage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$clientTable(model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
...
var _user$project$View$homePage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('This is the Home Page'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Should have a grey background'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$view = function (model) {
	...
	var _p1 = model.page;
	if (_p1.ctor === 'Home') {
		return _user$project$View$homePage(model);
	} else {
		return _user$project$View$clientPage(model);
	}
};
